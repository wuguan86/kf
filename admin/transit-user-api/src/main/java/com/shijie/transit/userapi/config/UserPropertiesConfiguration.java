...
import com.shijie.transit.userapi.enterprisewechat.EnterpriseWeChatProperties;
...
@Configuration
@EnableConfigurationProperties({WeChatOpenProperties.class, WeChatMpProperties.class, DifyProperties.class, EnterpriseWeChatProperties.class})
