...
class WechatVisionServiceTest {
  ...
  void parseMarketingMomentsKeepsSemanticLikeFields() {
        ...
        .andRespond(withSuccess("""
            {
              "choices": [
                {
                  "message": {
                    "content": "{\\"contact\\":\\"Moments\\",\\"messages\\":[],\\"moments\\":[{\\"author\\":\\"Alice\\",\\"content\\":\\"new product\\",\\"timeText\\":\\"2小时前\\",\\"visualIndex\\":1,\\"suitableForLike\\":true,\\"suitableForComment\\":true,\\"alreadyLiked\\":true,\\"likeMenuAction\\":\\"unlike\\",\\"verticalRange\\":{\\"y\\":120,\\"h\\":180},\\"confidence\\":0.93}],\\"changed\\":true,\\"conversationType\\":\\"SYSTEM\\",\\"accountCategory\\":\\"NORMAL\\",\\"confidence\\":0.9}"
                  }
                }
              ]
            }
    ...
    assertEquals(true, response.moments().get(0).suitableForComment());
