...
export type AppRoute = 'assistant' | 'settings' | 'knowledge' | 'outbound-materials' | 'session-management' | 'marketing' | 'smart-sales' | 'data-statistics' | 'me' | 'system-settings'
    ...
    <div className={styles.appShell}>
      ...
      <div className={styles.appSidebar}>
        ...
        <nav className={styles.appNav}>
          ...
          <div
            className={`${styles.navItem} ${activeRoute === 'smart-sales' ? styles.active : ''} ${navigationDisabled ? styles.disabled : ''}`}
