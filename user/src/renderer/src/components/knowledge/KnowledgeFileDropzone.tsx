...
export default function KnowledgeFileDropzone({ disabled, selectedFile, onSelect, onClear }: Props): JSX.Element {
  ...
  const addFile = (list: FileList | null) => {
    ...
    if (!ALLOWED_EXTENSIONS.includes(extension)) {
      alert('仅支持 PDF、Word、TXT、MD、Excel 文件')
      return
    }
    ...
    <div className={styles.uploadContainer}>
      ...
      {selectedFile && (
        <div className={styles.filesWrapper}>
          <div className={`${styles.fileItem} ${styles.fileItemNew}`}>
            ...
            <div className={styles.fileInfo}>
              ...
              <div className={styles.fileMeta}>待清洗 · {(selectedFile.size / 1024 / 1024).toFixed(2)} MB</div>
            </div>
            <button className={`${styles.iconBtn} ${styles.deleteBtn}`} onClick={onClear} title="移除" disabled={disabled}>
